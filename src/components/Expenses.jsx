...
function Expenses(props) {
  let expenditureData = [ 
    ...
    { name: "Teaching Support", value: 23, color: "#F6E50E" }, 
    { name: "Research", value: 11, color: "#FFF688" }, 
    { name: "Financial Aid", value: 8, color: "#5F63EC" }, 
    { name: "Operations & Maintenance", value: 2, color: "#71A8FF" }, 
    { name: "Administration", value: 3, color: "cyan" }, 
    { name: "Services", value: 2, color: "#0F7AB4" }, 
    { name: "Public Service", value: 2, color: "#D4E4FF" }, 
    { name: "Depreciation & Interest", value: 6, color: "#E3A400"}]
